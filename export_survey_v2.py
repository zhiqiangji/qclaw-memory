# export_survey_v2.py - 导出问卷数据为 Excel（19人版，含胡巍）
import openpyxl
...
# 数据（19人，去重，按最早入学年份排序）
rows = [
    ["李海山",   "硕士",     "1997", "2006", "秦皇岛",     "燕山大学",                               "讲师",        "",                 "13933903648"],
    ["王丽霞",   "博士",     "1999", "2001", "长春",       "吉林建筑大学",                           "教授",        "质量评估中心主任",  "13944852030"],
    ...
    ["陈士军",   "博士",     "",     "2007", "南昌",       "东华理工大学",                            "副教授",      "",                 "18679957991"],
    ["马元顺",   "硕士",     "2008", "",     "北京",       "中国恩菲工程技术有限公司",                  "正高级工程师", "工管部副部长",      "15001232998"],
    ["陈伟华",   "硕士",     "2009", "",     "珠海",       "世荣兆业",                               "工程师",      "部门副职",          "13680300067"],
    ["胡巍",     "硕士",     "2009", "",     "连云港",     "连云港市审计局",                          "中级工程师",  "科长",              "18061393857"],
    ["孙雨洋",   "硕士",     "2010", "",     "哈尔滨",     "哈尔滨工业大学建筑设计研究院有限公司",       "副高级工程师", "",                "15134566904"],
    ["柴艳飞",   "硕士",     "2010", "",     "天津",       "中国建筑第六工程局有限公司",                "高级工程师",  "",                 "18920286350"],
    ["钟华",     "硕士",     "2011", "",     "哈尔滨",     "黑龙江省水利科学研究院",                   "高级工程师",  "",                 "13904630357"],
    ["常俊德",   "硕士",     "2011", "",     "哈尔滨",     "黑龙江省水利科学研究院",                   "高级工程师",  "规划中心副主任",     "13796688779"],
    ["王超",     "硕士",     "2012", "",     "南京",       "南京华泽环保工程有限公司",                  "副高级工程师", "结构专业负责人",    "18994046762"],
    ["李明轩",   "硕士",     "2012", "",     "成都",       "中国建筑西南设计研究院",                   "副高级工程师", "",                "18081076388"],
    ["洪文江",   "硕士",     "2013", "",     "哈尔滨",     "安博健康科技（黑龙江）有限公司",             "工程师",      "",                 "15124527886"],
    ["吴贤东",   "硕士",     "2015", "",     "天津",       "中国铁路设计集团有限公司",                 "高级工程师",  "",                 "15022409165"],
...
output_path = r"C:\Users\32891\Desktop\徐学燕教授历届学生信息_2026_25人_v2.xlsx"
wb.save(output_path)
